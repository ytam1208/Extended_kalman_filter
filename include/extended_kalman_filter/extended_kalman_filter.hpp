...
public:
    ExtendedKalmanFilter() {
        ...
        mat_p_.setIdentity();
        q_.setIdentity();
        q_ *= 0.025;      // Adjust this value based on your system
    }
    ~ExtendedKalmanFilter(){}
    ...
    /// @brief Motion Model for the Differential Drive Robot
    ...
    void Predict(const Vector<DIM_X>& velocity, const float32_t dt) {
        ...
        /*
            State transition F matrix (Jacobian of the motion model)
